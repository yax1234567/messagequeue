...
import com.yax.messagequeue.serializer.FastJsonRedisSerializer;
...
public class RedisCacheManager {
    ...
    /**
     * 如果存在key,则返回false，否则放入redis返回true
     *
     * @param key   键
     * @param value 值
     * @return
        ...
        try {
            obj = redisTemplate.execute(new RedisCallback<Object>() {
                ...
                public Object doInRedis(RedisConnection connection) throws DataAccessException {
                    ...
                    Boolean success = connection.setNX(serializer.serialize(key), fastJsonSerializer.serialize(value));
                    //connection.close();
                    return success;
                }
            });
    ...
    public boolean removeZsetByKeyValue(String key,Object value){
        try {
